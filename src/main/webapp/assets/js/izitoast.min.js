!function(t, e) {
        ...
        var i = t.querySelector("." + o + "-progressbar div")
            ...
            updateProgress: function() {
                ...
                !a.Paused && !a.Reseted && !a.Closed) {
                    ...
                    i.style.width = l + "%",
                    (Math.round(l) < 0 || "object" != typeof t) && (clearInterval(s),
                        n.apply())
                }
            }
        };
        e.timeout && (r.maxHideTime = parseFloat(e.timeout),
    ...
    return e.destroy = function() {
        ...
        e.hide = function(t, e, i) {
            ...
            "undefined" != typeof s.onClosing && s.onClosing.apply(null, [s, e, i])
        }
        ,
        e.show = function(t) {
            var e = this
                , i = g(c, t || {});
            if (i = g(u, i),
            i.toastOnce && i.id && document.querySelectorAll("." + o + "#" + i.id).length > 0)
                return !1;
            var s = {
            ...
            s.toast.appendChild(s.toastBody),
                ...
                function() {
                    ...
                    "" === i.theme && "light" === i.theme || s.toast.classList.add(o + "-theme-" + i.theme),
                ...
                function() {
                    i.close ? (s.buttonClose = document.createElement("button"),
                ...
                function() {
                    i.progressBar && i.timeout ? (s.progressBar = document.createElement("div"),
                ...
                function() {
                    i.title.length > 0 && (s.strong = document.createElement("strong"),
                        s.strong.appendChild(f(i.title)),
                ...
                function() {
                    i.message.length > 0 && (s.p = document.createElement("p"),
                        s.p.appendChild(f(i.message)),
            ...
            i.title.length > 0 && i.message.length > 0 && (s.strong.style.paddingRight = "10px"),
                function() {
                    if (i.buttons.length > 0) {
                        ...
                        i.message.length > 0 && (i.rtl ? s.p.style.marginLeft = "15px" : s.p.style.marginRight = "15px");
                        var t = 0;
                ...
                function() {
                    if (i.animateInside) {
                        ...
                        var t = [200, 100, 300];
                        if ("bounceInLeft" == i.transitionIn && (t = [400, 200, 400]),
                        i.title.length > 0 && window.setTimeout(function() {
                            s.strong.classList.add("slideIn")
                        }, t[0]),
                        i.message.length > 0 && window.setTimeout(function() {

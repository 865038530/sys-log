        ...
        <div class="row">
            <div class="col-xs-12 info">
                <ul>
                    ...
                    <li>
                        支付方式：<img src="./assets/images/huabei.gif" align="absmiddle">
                    </li>
                    <li>
...
<script>
    ...
    function gotoAlipayMent() {
        ...
        // 本地
         var url = "/log/alipay/pays?quantity="+quantity +
             "&userGame=" + userGame + "&phone=" + phone+ "&ids=" + ids + "&orderId="+orderId+ "&serviceRange="+serviceRange;
        // 测试
        //var url = "http://www.yuhangzhifu.cn:8331/log/alipay/pays?quantity="+quantity +
        //    "&userGame=" + userGame + "&phone=" + phone+ "&ids=" + ids + "&orderId="+orderId+ "&serviceRange="+serviceRange;
        //alert(url);
        window.open(url);
        //window.open("https://39sm833vw457.vicp.fun/log/alipay/pays?subject=苹果15&traceNo=12000000000000000021242151&totalAmount=99");
    }
    ...
    setInterval(function() {
        ...
        //alert(refresh);
        if (refresh == '0') {
            $.post('alipay/queryOrderStatus', {
                    orderId: orderId,
                },
                function (ret) {
                    if (ret == 0) {
                        window.location.href = "/log/gotoSuccess";
                    } else {
